...
def home(request):
    ...
    handymen = Product.objects.filter(active=True)
    fields = Category.objects.filter(active=True)
    context = {"handymen": handymen, "fields": fields}
...
def detail(request, slug):
    ...
    categories = Product.objects.filter(active=True)
